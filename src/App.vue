 ...
 <div id="app">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div v-show="fetching" class="overlayLoading position-fixed">
           <div class="row d-flex align-items-center" style="min-height:100vh;width:100vw">
              <div class="col-12 text-center">
                <p class="text-muted">Fetching live data...</p>
              </div>
           </div>
        </div>
